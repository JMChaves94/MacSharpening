...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (darkModeToggle) { // Verificar si el botón existe
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const scrollToTopQuickButton = quickMenu ? quickMenu.querySelector(".scroll-to-top") : null;

  if (quickMenu && scrollToTopQuickButton) {
    window.addEventListener("scroll", () => {
